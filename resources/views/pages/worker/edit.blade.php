                        ...
                        <div class="card-body">
                            <form action="{{ route('worker.update', $worker->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('worker', $worker->name) }}" placeholder="Edit name">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('job') is-invalid @enderror" name="job" value="{{ old('worker', $worker->job) }}" placeholder="Edit job">
                                ...
                                <a href="{{ route('worker.index') }}" class="btn btn-dark">
                                    Kembali
                                </a>
